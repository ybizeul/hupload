...
export function Haffix() {
    ...
    return(
        <>
            ...
            {location?.params.share != 'shares' &&
                <Tooltip withArrow arrowOffset={10} arrowSize={4} label="Back">
                    <ActionIcon size="lg" component={Link} to="/shares" color="blue" radius="xl"><IconArrowLeft style={{ width: '70%', height: '70%' }} /></ActionIcon>
                </Tooltip>
                }
            </Affix>
